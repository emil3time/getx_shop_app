...
/*   var managerController = Get.put<ManagerController>(ManagerController()); */
...
// Cart loigic
  ...
  //   });
  //   if (dummyList.any((element) => element.id == newProduct.id)) {
  //     var indexUpdatedProduct =
  //         dummyList.indexWhere((element) => element.id == newProduct.id);
  //     dummyList[indexUpdatedProduct] = newProduct;
  //   } else {
  //     newProduct.id = DateTime.now().toString();
  //     dummyList.add(newProduct);
  //   }
  //   Get.back();
  //   clearInitialValue();
  // }
  ...
  //   managerController.imageUrlController.text = newProduct.imageUrl;
  // }
  ...
  //   managerController.imageUrlController.text = '';
  // }
}
