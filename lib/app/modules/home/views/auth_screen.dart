...
class AuthCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      elevation: 8.0,
      child: Obx(()=> Container(
        height: autchController.authMode.value == AuthMode.signup ? 320 : 260,
        constraints:
            BoxConstraints(minHeight: autchController.authMode.value == AuthMode.signup ? 320 : 260),
            ...
            child: Column(
              children: <Widget>[
                ...
                if (autchController.authMode.value == AuthMode.signup)
                  TextFormField(
                    enabled: autchController.authMode.value == AuthMode.signup,
                    decoration: InputDecoration(labelText: 'Confirm Password'),
                    obscureText: true,
                    validator: autchController.authMode.value == AuthMode.signup
                        ? (value) {
                            if (value != autchController.passwordController.text) {
                ...
                autchController.isLoading.value ?
                 ...
                 : MaterialButton(
                    child:
                        Text(autchController.authMode.value == AuthMode.login ? 'LOGIN' : 'SIGN UP'),
